...
<div class="wrapper">
	<div class="header header-filter" style="background-image: url('assets/img/bgg.jpeg');height: 100%;">
                      ...
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            ...
                            <input class="mdl-textfield__input" type="text" id="firstName" name="firstName" autocomplete="off"/>
                            <label class="mdl-textfield__label" for="firstName"> <i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;First Name</label>
                          </div>
                        </div>
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" type="text" id="lastName" name="lastName" autocomplete="off" />
                            <label class="mdl-textfield__label" for="lastName"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Last Name</label>
                          </div>
                        </div>
                      </div>
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--12-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" id="userEmail" type="email" name="userEmail" autocomplete="off"/>
                      ...
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            ...
                            <input class="mdl-textfield__input" type="number" id="phoneNo" name="phoneNo" autocomplete="off"/>
                            <label class="mdl-textfield__label" for="phoneNo"> <i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Phone No.</label>
                          </div>
                        </div>
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" type="text" id="place" name="place" autocomplete="off" />
                            <label class="mdl-textfield__label" for="place"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Place</label>
                          </div>
                        </div>
                      </div>
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--12-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <select class="mdl-textfield__input" id="type" name="type">
                              ...
                              <option value="Wellnes Center">Wellnes Center</option>
                            </select>
                            <label class="mdl-textfield__label" for="type"><i class="fa fa-id-card" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Interested in:</label>
                          </div>
                        </div>
                      </div>
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--6-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" id="createPassword" type="password" name="createPassword" pattern=".{6,}"  autocomplete="off" />
                        ...
                        <div class="mdl-cell mdl-cell--6-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" id="confirmPassword" type="password" name="confirmPassword" pattern=".{6,}"  autocomplete="off" />
                            <label class="mdl-textfield__label" for="confirmPassword"> <i class="fa fa-unlock" aria-hidden="true"></i></i>&nbsp;&nbsp;&nbsp;Confirm Password</label>
                          </div>
                        </div>
                      </div>
                      <!-- Accent-colored raised button with ripple -->
                      <input  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" type="submit"  name="register" value="Register" />
                    </form><br><br>
			        </div>
			      </div>
			    </div>
