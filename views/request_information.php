			...
			<div class="align-loginc">
			    ...
			    <div class="mdl-cell mdl-cell--4-col align-login  mdl-cell--5-col-tablet mdl-cell--4-col-phone">
                  ...
                  <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Request Information</h2>
                  </div>
                      ...
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--12-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            ...
                            // ... ask if we are logged in here:
                            if ($login->isLoggedIn() == true) { ?>
                            <input class="mdl-textfield__input" id="userRequestName" type="text" name="userRequestName" value="<?php echo $_SESSION['firstName']." ".$_SESSION['lastName'];?>" autocomplete="off"/>
                            <?php } else { ?>
                            <input class="mdl-textfield__input" id="userRequestName" type="text" name="userRequestName" value="<?php echo $_SESSION['firstName'];?>" autocomplete="off"/>
                           <?php     }
                              ?>
                            <label class="mdl-textfield__label" for="userRequestName"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Name</label>
                          </div>
                        </div>
                      </div>
                      <div class="mdl-grid no-gutter">
                        <div class="mdl-cell mdl-cell--12-col">
                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-width">
                            <input class="mdl-textfield__input" id="userRequestSubject" type="text" name="userRequestSubject"/>
                            <label class="mdl-textfield__label" for="userRequestSubject"><i class="fa fa-pencil-square" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Subject</label>
                          </div>
                        </div>
                      </div>
                      <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col">
                          <div class="mdl-textfield mdl-js-textfield  mdl-textfield--floating-label full-width">
                            <textarea class="mdl-textfield__input" type="text" rows= "3" id="userRequestDescription" name="userRequestDescription" ></textarea>
                            <label class="mdl-textfield__label" for="userRequestDescription"><i class="fa fa-comments" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Request....</label>
                          </div>
                        </div>                        
                      </div>
                      <!-- Accent-colored raised button with ripple -->
                      <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" name="userRequest" type="submit">
                      <i class="fa fa-telegram" aria-hidden="true"></i> &nbsp; Submit</button> 
                    </form><br><br>
                  </div>
                </div>
			    </div>
